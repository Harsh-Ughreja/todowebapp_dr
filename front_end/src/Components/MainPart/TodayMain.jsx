...
import $ from 'jquery';
import { deleteTask, completeTask, getTodayTasks, updateTaskDetails, updateTaskTitle } from '../ApiCall/appApi';
        ...
        await getTodayTasks()
            .then((response) => {
                ...
                if (response_data.authenticated) {
                    setTasks(response_data.content.today_tasks);
                    setHasTaks(false);
                }
                else {
                    window.location = '/';
